...
st.markdown("<h1 style='text-align: center; color: #0000FF ;'><strong><u>Predict Blood Donation for Future Expectancy</u></strong></h1>", unsafe_allow_html=True)

image = Image.open('donate.jpg')
st.image(image,width=700)

st.sidebar.markdown("<h1 style='text-align: center; color:#0000FF ;'><strong><u>Specify Input Parameters</u></strong></h1>", unsafe_allow_html=True)
